import type { Message, ChatState, ToolCall, WeatherResult, MCPResult, ErrorResult, SessionInfo, ProjectContext } from '../../worker/types';
  ...
  async sendMessage(
    ...
    try {
      const response = await fetch(`${this.baseUrl}/chat`, {
        ...
        body: JSON.stringify({ message, model, context, stream: !!onChunk }),
      });
      if (!response.ok) {
